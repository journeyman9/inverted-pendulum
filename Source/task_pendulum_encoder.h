#ifndef TASKPENDULUMENCODER_H
#define TASKPENDULUMENCODER_H
...
class task_pendulum_encoder : public frt_task{
	protected:
	
	public: 
		// Constructor creates a motor encoder task object
		task_pendulum_encoder(const char*, unsigned portBASE_TYPE, size_t, emstream*);
