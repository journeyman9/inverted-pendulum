#ifndef TASKMOTORCOMMAND_H
#define TASKMOTORCOMMAND_H
...
class task_motor_command : public frt_task{
	protected:
	
	public: 
		// Constructor creates a motor encoder task object
		task_motor_command(const char*, unsigned portBASE_TYPE, size_t, emstream*);
